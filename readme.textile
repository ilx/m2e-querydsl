...
If you just want to use this plugin click on the Downloads button on github and download the latest zip. It's an archived eclipse p2 update site. Donwload it and add to the list of eclipse updates sites just as you would do it with any other local archive of eclipse p2 update site.
